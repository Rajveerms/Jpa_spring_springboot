...
public class TestController 
{
	...
	public static void main(String[] args) 
	{
		...
		Actor a1 = new Actor(1, "Ajay Devgan");
	//	Actor a2 = new Actor();
		
		em.persist(a1);
		
		Movie m1 = new Movie(101,"Singham", a1);
		Movie m2 = new Movie(102,"Drishyam",a1);
		...
		List<Movie> movieList = new ArrayList<Movie>(); // list of movies in actor 
		movieList.add(m1);
		movieList.add(m2);
